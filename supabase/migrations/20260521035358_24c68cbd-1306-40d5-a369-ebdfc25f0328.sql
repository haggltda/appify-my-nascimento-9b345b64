CREATE OR REPLACE FUNCTION public.export_orcamento_completo_dump()
RETURNS SETOF jsonb
LANGUAGE sql
SECURITY DEFINER
...
AS $$
  SELECT to_jsonb(t) FROM (
    SELECT
      ...
      l.conta_contabil_id, ct.conta_reduzida AS conta_reduzida, ct.classificacao AS conta_classificacao,
...
$$;
REVOKE ALL ON FUNCTION public.export_orcamento_completo_dump() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.export_orcamento_completo_dump() TO anon, authenticated, service_role;
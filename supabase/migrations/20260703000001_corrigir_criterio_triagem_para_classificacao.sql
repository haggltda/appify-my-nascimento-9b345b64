-- Corrige a trava de avanco da triagem_inicial para analise_necessidade:
-- usa o novo campo triagem_classificacao = 'sistema' em vez do antigo
-- criterio_triagem = 'necessidade_desenvolvimento'.
-- Atualiza tambem a mensagem de erro para "Necessidade de Sistemas".

...
SELECT m.id, x.codigo, x.nome, x.rota, x.ordem FROM (VALUES
  ...
  ('controladoria','empresas','Empresas','/app/controladoria/empresas',10),
  ('controladoria','cc','Centros de Custo','/app/controladoria/centros-custo',20),
  ('controladoria','dre','Linhas DRE','/app/controladoria/dre',30),
  ('controladoria','obz','Planejador OBZ','/app/controladoria/obz',40),
